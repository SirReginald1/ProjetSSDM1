...
kbl(temp[1:5,], format = "html", row.names = FALSE,
    caption = "Table 10: Les 5 meilleur modèles avec validation croisé a 3 folds")
```



```{r, eval=FALSE}
time = system.time({model_svm_best = svm(x = data_train[,-1],
                                         y = data_train[,1],
                                         type = "C-classification",
                                         kernel = svm_opti[1,1],
...
Résultat des tests n et p avec les modèles SVM et XGBoost optimal.
